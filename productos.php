...
<nav class="main-nav">
        ...
        <a href="login.html" class="nav-link">Stock</a>
        <a href="ad.php" class="nav-link">AD</a>
        <a href="cbx.php" class="nav-link">CBX</a>
        <a href="eterna.php" class="nav-link">Eterna</a>
        <a href="mdf.php" class="nav-link">MDF</a>
        <a href="personalizados.php" class="nav-link">Trabajos Personalizados</a>
        <style type="text/CSS">
          a:link {
